    ...
    <div class="orders-container">
      <div v-for="order in pointorders" :key="order.id" class="order-block">
        ...
        <div class="status-buttons">
          <button class="sent" @click="updateStatus(order.id, 'надіслано')">Надіслано</button>
          <button class="returned" @click="updateStatus(order.id, 'повернулося на склад')">Повернулося на склад</button>
        </div>
      </div>
    </div>
  </div>
